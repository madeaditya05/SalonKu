                ...
                <tbody>
                    @forelse ($staffs as $index => $staff)
                        @php
                            ...
                            $subCategoryName = optional($subCategories->firstWhere('id', $staff->sub_category_id))->name ?? $staff->sub_category_id;
                            ...
                            $staffPayload = [
                                ...
                                'sub_category_id' => $staff->sub_category_id,
                                'branch_id' => $staff->branch_id,
                                'status' => $staff->status ?? 'active',
                                'update_url' => route('provider.staffs.update', $staff->id),
                                'delete_url' => route('provider.staffs.destroy', $staff->id),
                            ];
                        @endphp
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="staff-branch-cell">
                                    ...
                                    <small>{{ $categoryName ?: '-' }}{{ $subCategoryName ? ' / ' . $subCategoryName : '' }}</small>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="staff-action-group">
                                    ...
                                    <button
                                        ...
                                        title="Delete"
                                        data-delete-url="{{ route('provider.staffs.destroy', $staff->id) }}"
                                    >
                                        <svg viewBox="0 0 24 24">
                                            <path d="M3 6h18"/>
                                            <path d="M8 6V4h8v2"/>
...
<div class="staff-modal-overlay" id="staffModal">
    <div class="staff-modal">
        ...
        <form action="{{ route('provider.staffs.store') }}" method="POST" enctype="multipart/form-data" id="staffForm">
            @csrf
    ...
    @endforeach
                    ...
                    <div class="staff-form-group">
                        ...
                        <select name="sub_category_id" id="staffSubCategorySelect" required>

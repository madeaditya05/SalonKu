...
<section class="provider-branch-page">
    <div class="branch-index-header">
        ...
        <div class="branch-header-actions">
            ...
            <a href="{{ route('provider.branch.create') }}" class="branch-add-btn">
                <svg viewBox="0 0 24 24">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="branch-action-group">
                                    <a href="{{ route('provider.branch.edit', $branch->id) }}" class="branch-icon-btn edit" title="Edit">
                                        <svg viewBox="0 0 24 24">
                                            <path d="M12 20h9"/>
                                    ...
                                    <button
                                        ...
                                        title="Delete"
                                        data-delete-url="{{ route('provider.branch.destroy', $branch->id) }}"
                                    >
                                        <svg viewBox="0 0 24 24">
                                            <path d="M3 6h18"/>
                                            <path d="M8 6V4h8v2"/>

...
const sourceEnglishToIndonesian = {
    ...
    'Payment Setup Failed': 'Setup Pembayaran Gagal',
    'Payment Expired': 'Pembayaran Expired',
    Expired: 'Expired',
    'Preparing Payment': 'Menyiapkan Pembayaran',
    'Booking Cancelled': 'Booking Dibatalkan',
    'Payment Cancelled': 'Pembayaran Dibatalkan',
    'Your booking has been created. Complete payment to secure your salon visit.': 'Booking kamu sudah dibuat. Selesaikan pembayaran untuk mengamankan kunjungan salon.',
    'Your booking has been created, but the payment could not be completed.': 'Booking kamu sudah dibuat, tapi pembayaran belum berhasil diselesaikan.',
    'Your booking has been created, but payment instructions could not be generated yet.': 'Booking kamu sudah dibuat, tapi instruksi pembayaran belum bisa dibuat.',
    'Your booking has been created. Payment instructions are being prepared.': 'Booking kamu sudah dibuat. Instruksi pembayaran sedang disiapkan.',
    'The 7 minute payment window has ended. This booking payment is now expired.': 'Batas pembayaran 7 menit sudah habis. Pembayaran booking ini sekarang expired.',
    'This booking has been cancelled. No payment is required.': 'Booking ini sudah dibatalkan. Tidak ada pembayaran yang diperlukan.',
    'Payment flow stopped because the booking was cancelled.': 'Alur pembayaran dihentikan karena booking dibatalkan.',
    'Payment instructions could not be generated. Try again from the payment card below.': 'Instruksi pembayaran belum bisa dibuat. Coba ulang dari kartu pembayaran di bawah.',
    'Preparing payment instructions. You can stay on this page while we connect to Midtrans.': 'Instruksi pembayaran sedang disiapkan. Kamu bisa tetap di halaman ini saat kami terhubung ke Midtrans.',
    Preparing: 'Menyiapkan',
    'Needs Retry': 'Perlu Dicoba Ulang',
    'Preparing instructions': 'Menyiapkan instruksi',
    'Payment setup failed': 'Setup pembayaran gagal',
    'Location accuracy is low. Turn on precise location or type your city manually.': 'Akurasi lokasi rendah. Aktifkan lokasi presisi atau ketik kota kamu secara manual.',
    Passed: 'Lewat',
    'Preparing payment instructions with Midtrans. This can take a moment on sandbox.': 'Instruksi pembayaran sedang disiapkan lewat Midtrans. Di sandbox proses ini bisa butuh beberapa saat.',
    'Payment instructions could not be generated yet.': 'Instruksi pembayaran belum bisa dibuat.',
    'Payment instructions have not been generated yet.': 'Instruksi pembayaran belum dibuat.',
    'Payment could not be completed. Please check the payment status or make a new booking.': 'Pembayaran belum bisa diselesaikan. Cek status pembayaran atau buat booking baru.',
    'Payment has been received.': 'Pembayaran sudah diterima.',
    'Payment deadline': 'Batas pembayaran',
    'Connecting to Midtrans...': 'Menghubungkan ke Midtrans...',
    'Retry payment setup to generate a new instruction.': 'Coba ulang setup pembayaran untuk membuat instruksi baru.',
    'Retry Payment Setup': 'Coba Ulang Pembayaran',

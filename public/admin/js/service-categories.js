document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    function closeModal(modal) {
        ...
        const openedModal = document.querySelector('.category-modal.show');
    ...
    document.addEventListener('click', function (event) {
        ...
        if (closeButton) {
            ...
            const modal = closeButton.closest('.category-modal');
            closeModal(modal);
        }
    });
    ...
    */
    ...
    document.querySelectorAll('.upload-box').forEach(function (uploadBox) {
        const input = uploadBox.querySelector('[data-upload-input]');
